...
DENSE_HEADERS = sparsehash/dense_hash_set sparsehash/dense_hash_map sparsehash/wrapped_dense_hash_set sparsehash/wrapped_dense_hash_map sparsehash/internal/densehashtable.h sparsehash/internal/hashtable-common.h sparsehash/traits
...
hashtable_extkey_unittests.o: $(TEST_DIR)/hashtable_extkey_unittests.cc $(HEADERS)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(TEST_DIR)/hashtable_extkey_unittests.cc

testmain.o : $(TEST_DIR)/*.cc 
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(TEST_DIR)/testmain.cc 	

sparsehash_unittests : simple_unittests.o sparsetable_unittests.o allocator_unittests.o hashtable_unittests.o hashtable_c11_unittests.o hashtable_extkey_unittests.o fixture_unittests.o testmain.o gmock-gtest-all.o
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $^ -o $@ $(LDFLAGS)
